...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Capstone Project Finder</title>
        <meta
          name="description"
      ...
      <main className="mt-20 text-center px-4">
        <section className="bg-[var(--foreground)] text-[var(--background)] py-16">
          <h1 className="text-4xl font-bold mb-4">Welcome to Capstone Project Finder</h1>
          <p className="text-lg mb-8">
            Find, research, and select the perfect final year project that aligns with your career goals.
      ...
      <footer className="text-center py-6 border-t border-[var(--foreground)]">
        <p> 2025 Capstone Project Finder</p>
      </footer>
    </div>
  );
}
